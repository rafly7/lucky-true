export function ResultNameWinner({listWinner, index}) {
  ...
  return (
    splitNameWinner.map((val, index) => (
      <div style={{marginBottom: '10px',marginInlineEnd: '10px', borderRadius: '10px', backgroundColor: '#fb9300', display: 'inline-flex', flexWrap: 'wrap', flexDirection: 'column', paddingTop: '0.5rem', paddingBottom: '0.5rem', paddingRight: '1.25rem', paddingLeft: '1.25rem'}}>
      <div style={{ display: 'inline', flexDirection: 'column', flexWrap: 'wrap'}} key={index}>
